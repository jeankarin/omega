...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(570, 401)
        MainWindow.setMinimumSize(QtCore.QSize(570, 401))
        MainWindow.setMaximumSize(QtCore.QSize(570, 401))
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 150, 551, 221))
        self.plainTextEdit.setReadOnly(True)
        self.plainTextEdit.setObjectName(_fromUtf8("plainTextEdit"))
        self.ReloadButton = QtGui.QPushButton(self.centralwidget)
        self.ReloadButton.setEnabled(False)
        self.ReloadButton.setGeometry(QtCore.QRect(460, 70, 98, 27))
